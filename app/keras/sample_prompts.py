...
stock_charts = {
    'What is the recent stock performance of Apple Inc.?': 'stock-chart',
    'Display a chart for Amazon\'s stock in the last month.': 'stock-chart',
    'How has Google\'s stock been performing compared to Microsoft?': 'stock-chart',
    'Show the stock price trend for Facebook in the past six months.': 'stock-chart',
    'What is the historical performance of Netflix stock in the last year?': 'stock-chart',
    'Plot a graph of the stock performance for NVIDIA Corporation.': 'stock-chart',
    'Compare the stock prices of Coca-Cola and PepsiCo in the last quarter.': 'stock-chart',
    'Show me the trend for the S&P 500 index over the past five years.': 'stock-chart',
    'Display a chart for the technology sector\'s stock performance.': 'stock-chart',
    'What is the current stock value of Microsoft?': 'stock-chart',
    'What is the recent stock performance of Apple Inc.?': 'stock-chart',
    'Display a chart for Amazon\'s stock in the last month.': 'stock-chart',
    'How has Google\'s stock been performing compared to Microsoft?': 'stock-chart',
    'Show the stock price trend for Facebook in the past six months.': 'stock-chart',
    ...
    'Display a chart for the technology sector\'s stock performance.': 'stock-chart',
    'What is the current stock value of Microsoft?': 'stock-chart',
    'Display a chart for Tesla\'s stock in the last month.': 'stock-chart',
    'How has Apple Inc.\'s stock been performing compared to Amazon?': 'stock-chart',
    'Show the stock price trend for Google in the past six months.': 'stock-chart',
    'What is the historical performance of Microsoft stock in the last year?': 'stock-chart',
    'Plot a graph of the stock performance for Intel Corporation.': 'stock-chart',
    'Compare the stock prices of Disney and Netflix in the last quarter.': 'stock-chart',
    'Show me the trend for the Nasdaq Composite index over the past five years.': 'stock-chart',
    'Display a chart for the healthcare sector\'s stock performance.': 'stock-chart',
    'What is the current stock value of Amazon?': 'stock-chart',
    'What is the recent stock performance of Microsoft?': 'stock-chart',
    'Display a chart for Facebook\'s stock in the last month.': 'stock-chart',
    'How has Amazon\'s stock been performing compared to Google?': 'stock-chart',
    'Show the stock price trend for Apple Inc. in the past six months.': 'stock-chart',
    'What is the historical performance of Facebook stock in the last year?': 'stock-chart',
    'Plot a graph of the stock performance for AMD (Advanced Micro Devices).': 'stock-chart',
    'Compare the stock prices of Microsoft and Apple Inc. in the last quarter.': 'stock-chart',
    'Show me the trend for the Dow Jones Industrial Average over the past five years.': 'stock-chart',
    'Display a chart for the energy sector\'s stock performance.': 'stock-chart',
    'What is the current stock value of Google?': 'stock-chart',
    'Display a chart for Netflix\'s stock in the last month.': 'stock-chart',
    'How has Facebook\'s stock been performing compared to Apple Inc.?': 'stock-chart',
    'Show the stock price trend for Amazon in the past six months.': 'stock-chart',
    'What is the historical performance of Amazon stock in the last year?': 'stock-chart',
    'Plot a graph of the stock performance for Tesla.': 'stock-chart',
    'Compare the stock prices of Google and Facebook in the last quarter.': 'stock-chart',
    'Show me the trend for the Russell 2000 index over the past five years.': 'stock-chart',
    'Display a chart for the financial sector\'s stock performance.': 'stock-chart',
    'What is the current stock value of Facebook?': 'stock-chart',
    'Display a chart for Microsoft\'s stock in the last month.': 'stock-chart',
    'How has Tesla\'s stock been performing compared to Apple Inc.?': 'stock-chart',
    'Show the stock price trend for Amazon in the past six months.': 'stock-chart',
    'What is the historical performance of Google stock in the last year?': 'stock-chart',
    'Plot a graph of the stock performance for Adobe Inc.': 'stock-chart',
    'Compare the stock prices of Amazon and Microsoft in the last quarter.': 'stock-chart',
    'Show me the trend for the FTSE 100 index over the past five years.': 'stock-chart',
    'Display a chart for the consumer goods sector\'s stock performance.': 'stock-chart',
    'What is the current stock value of Tesla?': 'stock-chart',
    'Display a chart for NVIDIA Corporation\'s stock in the last month.': 'stock-chart',
    'How has Microsoft\'s stock been performing compared to Amazon?': 'stock-chart',
    'Show the stock price trend for Google in the past six months.': 'stock-chart',
    'What is the historical performance of Apple Inc. stock in the last year?': 'stock-chart',
    'Plot a graph of the stock performance for IBM (International Business Machines).': 'stock-chart',
    'Compare the stock prices of Amazon and Facebook in the last quarter.': 'stock-chart',
    'Show me the trend for the Nikkei 225 index over the past five years.': 'stock-chart',
    'Display a chart for the industrial sector\'s stock performance.': 'stock-chart',
    'What is the current stock value of Amazon?': 'stock-chart',

}

stock_chart_dict = {prompt:'other' for prompt in stock_charts}

sample_data = {**sample_data,**stock_chart_dict}